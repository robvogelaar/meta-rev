...
do_compile() {
    ...
    ${CXX} ${CXXFLAGS} ${LDFLAGS} ${WORKDIR}/addon3.cpp -shared -Wl,-soname,addon3.node -o addon3.node -Wall         -O2 -fPIC -fno-exceptions -fno-rtti -fpermissive -std=c++0x -lutils
}
...
do_install() {
    ...
    install -m 0755 ${S}/addon3.node ${D}${libdir}/node_modules
    install -m 0755 ${WORKDIR}/test3.js ${D}${libdir}/node_modules
}
